...
def run(args):
    ...
    for ist in range(len(clients_ids)):
        ...
        data_num.append(len(cd.train_dataset))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ss','--subset_size', type=int, default=50, help='Subset size')
    ...
    parser.add_argument('-s', '--split_num', type=int, default=3, help='Split number (Max 3, Min 2)')
