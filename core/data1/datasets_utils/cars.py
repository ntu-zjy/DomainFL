...
class Cars:
    def __init__(self,
        ...
        self.train_dataset = PytorchStanfordCars(location, 'train', train_preprocess, download=True)
        ...
        self.test_dataset = PytorchStanfordCars(location, 'test', val_preprocess, download=True)
